    ...
    <div className={css.card}>
      ...
      >
        <Form className={css.form}>
          ...
          <FormField name="phone" label="Phone" placeholder="+380501234567" />
      ...
      <div className={css.stats}>
        <div className={css.stat}>
          ...
          <span className={css.statLabel}>Plants</span>
        </div>
        <div className={css.stat}>
          <span className={css.statValue}>{stats?.wateringStreak ?? 0}</span>
